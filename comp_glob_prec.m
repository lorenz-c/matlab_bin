...
% for i = 1:10
%     h = figure
%     set(h, 'papersize', [4.5 4], 'paperunits', 'centimeters', 'resize', 'off')
%     
%     plot(gpcp_ann(:,i)   - gpcc_ann(:,i), '^-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
%     hold on
%     plot(cru_ann(:,i)  - gpcc_ann(:,i), 'o-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
%     plot(cpc_ann(:,i)   - gpcc_ann(:,i), '*-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
%     plot(ecmwf_ann(:,i) - gpcc_ann(:,i), 'kp-', 'linewidth', 1.5, 'markersize', 8);
%     plot(merra_ann(:,i) - gpcc_ann(:,i), 'kx-', 'linewidth', 1.5, 'markersize', 8);
%     plot(cfsr_ann(:,i)  - gpcc_ann(:,i), 'kd-', 'linewidth', 1.5, 'markersize', 8);
% 
%     grid on
%     axis([1 18 -1 1]);
...
% 
%     set(gca, 'yticklabel', ylab, 'fontsize', 16);
...
%     if i == 1
%         leg = legend('GPCP', 'CRU', 'CPC', 'INTERIM', 'MERRA', 'CFSR');
%         set(leg, 'fontsize', 12, 'location', 'Best', 'orientation', 'horizontal')
%         keyboard
%     end
...
%     set(h, 'papersize', [4.5 4], 'paperunits', 'centimeters', 'resize', 'off')
%     
%     plot(gpcp_mon(:,i)   - gpcc_mon(:,i), '^-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
%     hold on
%     plot(cru_mon(:,i)  - gpcc_mon(:,i), 'o-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
%     plot(cpc_mon(:,i)   - gpcc_mon(:,i),  '*-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
%     plot(ecmwf_mon(:,i) - gpcc_mon(:,i),'kp-', 'linewidth', 1.5, 'markersize', 8);
%     plot(merra_mon(:,i) - gpcc_mon(:,i),  'kx-', 'linewidth', 1.5, 'markersize', 8);
%     plot(cfsr_mon(:,i)  - gpcc_mon(:,i), 'kd-', 'linewidth', 1.5, 'markersize', 8);
% 
%     grid on
%     axis([1 12 -1.5 1.5]);
...
for i = 1:10
    ...
    plot(gpcp_ann(:,i), '^-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
    hold on
    plot(cru_ann(:,i), 'o-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
    plot(cpc_ann(:,i), '*-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
    plot(ecmwf_ann(:,i), 'kp-', 'linewidth', 1.5, 'markersize', 8);
    plot(merra_ann(:,i), 'kx-', 'linewidth', 1.5, 'markersize', 8);
    plot(cfsr_ann(:,i), 'kd-', 'linewidth', 1.5, 'markersize', 8);
    ...
    text(2, 0.5, text_str{i} , 'fontsize', 20);
    if i == 1
        leg = legend('GPCP', 'CRU', 'CPC', 'INTERIM', 'MERRA', 'CFSR');
        set(leg, 'fontsize', 14, 'location', 'Best', 'orientation', 'horizontal')
        keyboard
    end
    print(h, '-depsc2', fnames_ann{i});
    clear h
    ...
    plot(gpcp_mon(:,i), '^-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
    hold on
    plot(cru_mon(:,i), 'o-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
    plot(cpc_mon(:,i),  '*-', 'linewidth', 1.5,'color', [0.4 0.4 0.4], 'markersize', 8);
    plot(ecmwf_mon(:,i),'kp-', 'linewidth', 1.5, 'markersize', 8);
    plot(merra_mon(:,i),  'kx-', 'linewidth', 1.5, 'markersize', 8);
    plot(cfsr_mon(:,i), 'kd-', 'linewidth', 1.5, 'markersize', 8);
